    ...
    "LOAN_TERMS": {
        ...
        "fields": {
            ...
            "PURPOSE": FieldMetadata(
                ...
                values={"P": "Purchase - Home acquisition", "R": "Rate/Term Refinance", "C": "Cash-Out Refinance"},
            ),
    ...
    "BORROWER_PROFILE": {
        ...
        "fields": {
            "CSCORE_B": FieldMetadata(
                ...
                values={"740+": "Super Prime", "680-739": "Prime", "620-679": "Near Prime", "<620": "Subprime"},
            ),
    ...
    "MORTGAGE_INSURANCE": {
        ...
        "fields": {
            "MI_TYPE": FieldMetadata(
                ...
                values={"1": "Borrower-paid monthly MI", "2": "Lender-paid MI", "3": "Split premium MI"},
            ),
            ...
            for _, row in schema_df.iterrows():
                ...
                if not found:
                    unmapped_columns.append(
                        f"    {column_name} {column_type} -- {column_name.replace('_', ' ').title()}"
                    )
